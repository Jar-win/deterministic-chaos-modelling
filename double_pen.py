...
bar2 = box( pos=axle2.pos+vec(L2display/2-d/2,0,(gap+d)/2), 
        size=vec(L2display,d,d), color=color.green,make_trail=True,
        trail_type='points', interval=1, retain=500 )
